local config = {
    ...
    useMessage = true,
    expirationMessage = 'Seus dias VIP acabaram.',
    expirationMessageType = MESSAGE_INFO_DESCR
}
...
function Player.onRemoveVip(self)
  ...
  if config.useTeleport then
	...
	local outfitsToDelete = {514, 516, 634, 635, 1243, 1244} -- outfits ids
...
function Player.addAddonMount(self)
	...
	local outfitsToUpgrade = {514, 516, 634, 635, 1243, 1244} -- add outfits ids
